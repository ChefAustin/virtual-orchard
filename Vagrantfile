...
boxes.each do |macinbox|
  Vagrant.configure(2) do |config|
    ...
    config.vm.provision 'file', source: "ENV['HOME']/.vagrant.d/provisioning/CommandLineToolsmacOSMojaveVersion10.14.pkg", destination: '$HOME/CommandLineToolsmacOSMojaveVersion10.14.pkg'
